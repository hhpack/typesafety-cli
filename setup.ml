...
(* OASIS_START *)
(* DO NOT EDIT (digest: cbd91b812c70630dcc759db471c7acaa) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.04.2");
          version = "0.9.0";
          license =
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "typesafety";
                      lib_findlib_name = Some "github";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "3.1.0"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Process"; "Process_result"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "typesafety";
                      lib_findlib_name = Some "process";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("atdgen",
                               Some (OASISVersion.VGreaterEqual "1.10.2"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "typesafety";
                      lib_findlib_name = Some "typechecker";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "3.1.0"));
                           InternalLibrary "process";
                           InternalLibrary "misc";
                           InternalLibrary "typechecker"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules =
                        ["Hh_config"; "Hh_client"; "Hhvm_version"; "Hhvm"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "typesafety";
                      lib_findlib_name = Some "hhvm";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cohttp",
                               Some (OASISVersion.VGreaterEqual "0.99.0"));
                           FindlibPackage
                             ("cohttp.lwt",
                               Some (OASISVersion.VGreaterEqual "0.99.0"));
                           FindlibPackage
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("threads", None);
                           FindlibPackage ("str", None);
                           InternalLibrary "hhvm";
                           InternalLibrary "hack";
                           InternalLibrary "misc";
                           InternalLibrary "review";
                           InternalLibrary "typechecker"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "typesafety";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cmdliner",
                               Some (OASISVersion.VGreaterEqual "1.0.0"));
                           InternalLibrary "typesafety"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "typesafety_review.ml"
                   });
               Executable
                 ({
                     cs_name = "test";
     ...
     oasis_digest = Some "\222\197q\216\189\159\149@\229\179\237M\1509\199\\";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
