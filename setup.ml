...
(* OASIS_START *)
(* DO NOT EDIT (digest: 57f8847d7ee0dd36a9cad3b41b7d69d2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hhpack/typesafety-cli";
          bugreports = Some "https://github.com/hhpack/typesafety-cli/issues";
          synopsis = "Typechecker powerful wrapper for HHVM/Hack";
          description =
            Some
              [
                 OASISText.Para
                   "Detailed information display of type error and review comments to Github will support development with HHVM/Hack. typesafety is designed for use in the CI environment and now supports Travis CI."
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/hhpack/typesafety-cli.git";
                      src_repo_browser =
                        Some "https://github.com/hhpack/typesafety-cli";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "typesafety_github";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_misc";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["File"; "Color"; "Log"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_misc";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_hack";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/hack";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "typesafety_misc"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules =
                        ["Source_file"; "Source_lines"; "Source_cache"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_hack";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_env";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "typesafety_github"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Env"; "Ci_env"; "Ci_detector"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_env";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_typechecker";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules =
                        ["Typechecker_check_t"; "Typechecker_check_j"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_typechecker";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_hhvm";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("process", None);
                           InternalLibrary "typesafety_misc";
                           InternalLibrary "typesafety_typechecker"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Hh_config"; "Hh_client"; "Hhvm"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_hhvm";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_review";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "typesafety_misc";
                           InternalLibrary "typesafety_env";
                           InternalLibrary "typesafety_hack";
                           InternalLibrary "typesafety_typechecker"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_review";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "typesafety_cli";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "typesafety_hhvm";
                           InternalLibrary "typesafety_hack";
                           InternalLibrary "typesafety_misc";
                           InternalLibrary "typesafety_review";
                           InternalLibrary "typesafety_typechecker"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules =
                        ["Typesafety_check"; "Typesafety_reporter"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "typesafety_cli";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cmdliner", None);
                           FindlibPackage ("process", None);
                           InternalLibrary "typesafety_cli";
                           InternalLibrary "typesafety_hack";
                           InternalLibrary "typesafety_misc";
                           InternalLibrary "typesafety_env";
                           InternalLibrary "typesafety_hhvm";
                   ...
                   {exec_custom = false; exec_main_is = "typesafety.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                    ...
                    (OASISExpr.EBool true,
                      Some
                        (("atdgen",
                           [
                              "-t";
                              "src/typechecker/typechecker_check.atd";
                              "-o";
                              "src/typechecker/typechecker_check\natdgen";
                              "-j";
                              "src/typechecker/typechecker_check.atd";
                              "-o";
                              "src/typechecker/typechecker_check\natdgen";
                              "-t";
                              "src/review/github.atd";
                              "-o";
                              "src/review/github\natdgen";
                              "-j";
                              "src/review/github.atd";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "t\150%\137\007K[9=\159\245\208\n\144\147g";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
