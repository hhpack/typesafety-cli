...
(* OASIS_START *)
(* DO NOT EDIT (digest: cff1530422e9d1d3a061fdf9a2b263a7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "Type check wrapper for Hack";
          description = Some [OASISText.Para "Type check wrapper for Hack"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\1483\187\247v{\029\020\022\000>\237h\144V\249";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
