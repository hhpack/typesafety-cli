...
(* OASIS_START *)
(* DO NOT EDIT (digest: 23047a50ac3272ad8a7cca13851dba46) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.04.1");
          version = "0.5.1";
          license =
     ...
     oasis_digest = Some "\172\242C\143\0009s\022\174\002\147\251cx\133\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
