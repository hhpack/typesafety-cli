...
(* OASIS_START *)
(* DO NOT EDIT (digest: ce79b6dd1d4c91ab63ff45d2f9b5da51) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.7";
     oasis_digest =
       Some "\020\150\228\0008\136\204\157\205\241\178\134\167\147\222\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
